...
tr.d1 td {
  ...
  color: black;
			...
			<div class="clearfix">
				...
				<p style="text-align:center;font-size:20px;font-weight:600;">Rent Receipt</p>
				<table >
					<tr>
		...
		<br><br>
		<p style="color:#ff4200">Note: $rent_remark</p>
...
$filepath = $_SERVER["DOCUMENT_ROOT"].'payrtz/Documents/customer/'.$customerid.'/rentreceipt'.$customername.'-'.$dateee.'-'.$month.'.pdf';

	// $pdf->Write(0, $html, '', 0, 'C', true, 0, false, false, 0);
$pdf->Output($_SERVER["DOCUMENT_ROOT"].'/payrtz/Documents/customer/'.$customerid.'/rentreceipt'.$customername.'-'.$dateee.'-'.$month.'.pdf','F');
...
$mail->AddAttachment($_SERVER["DOCUMENT_ROOT"].'/payrtz/Documents/customer/'.$customerid.'/rentreceipt'.$customername.'-'.$dateee.'-'.$month.'.pdf');
$mail->send();
