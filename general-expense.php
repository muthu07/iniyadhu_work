      ...
      <div class="row">
		...
		<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">General Expense</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="generalexpenseform">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea class="form-control" rows="3" id="expense_remark" placeholder="Enter ..."></textarea>	
